<template lang="pug">
.how-to-play-unlimited-mode-content
  p Her harfe karşılık gelen sorunun cevabını bulmalısın, cevap o harf ile başlar.<br><br>
    ...
    | <br><br> <strong>parolla</strong> oyunu <strong>{{ String(ALPHABET_LENGTH) }}</strong> türkçe alfabe harfi içerir.
    | <br>Bu modu tekrar tekrar oynayabilirsin. Her defasında farklı sorular gelir.
</template>
...
<style lang="scss" src="./HowToPlayUnlimitedModeContent.component.scss"></style>
