  ...
  setup(props, { emit }) {
    ...
    const initKeyboard = async () => {
      ...
      keyboard.value = new Keyboard('.app-keyboard', {
        ...
        layoutName: 'default',
        layout: {
          default: ['q w e r t y u ı o p ğ ü', '{tab} a s d f g h j k l ş i', 'z x c v b n m ö ç {backspace}', '{pass} {space} {enter}'],
          shift: ['Q W E R T Y U I O P Ğ Ü', '{tab} A S D F G H J K L Ş İ', 'Z X C V B N M Ö Ç {backspace}', '{pass} {space} {enter}']
        },
        display: {
          '{tab}': 'TAB',
          '{space}': 'BOŞLUK',
